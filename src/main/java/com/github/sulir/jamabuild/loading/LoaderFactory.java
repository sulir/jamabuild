...
public class LoaderFactory {
    ...
    public static Loader createLoader(String rootDirectory, String type, String id) throws ProjectLoadingException {
        ...
        return switch (type) {
            ...
            default -> throw new ProjectLoadingException("Unknown loader: " + type);
        };
    }
}
